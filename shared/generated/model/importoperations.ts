...
/**
	<p>The representation sent to the server when creating and updating an import operation.</p>
*/
export interface ImportOperationDraft {
  /**
  	<p>The import operation version.</p>
  */
  readonly version: number;
  ...
  */
  readonly resourceVersion?: number;
  /**
  	<p>The status of a single import request.
  	The status of the import resource.</p>
  */
  readonly state: ProcessingState;
  /**
  	<p>The number of request retries for processing the import resource.</p>
  */
  readonly retryCount: number;
  /**
  	<p>The unresolved references that still are missing for the import resource.</p>
  */
  readonly unresolvedReferences?: KeyReference[];
  /**
  	<p>The errors reported for the import resource.</p>
  */
  readonly errors?: ErrorObject[];
  /**
  	<p>When the import operation expires.</p>
